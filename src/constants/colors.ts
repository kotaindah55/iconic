 ...
 */
export const DEFAULT_COLORS = new Map<string, string>([
	['red', '--color-red'],
	['orange', '--color-orange'],
	['yellow', '--color-yellow'],
	['green', '--color-green'],
...
export const RGB_FALLBACK = 'rgb(128, 128, 128)';